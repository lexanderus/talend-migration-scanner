// analyzer-umd.js
// UMD bridge — wraps analyzer.js for classic Worker importScripts
// Attaches classifyNode, classifyJob, scoreJob, buildResult to self.TMS_ANALYZER
...
self.TMS_ANALYZER = (function() {
   ...
   */
  function scoreJob(status, nodes) {
   ...
   */
  function buildResult(jobs, elapsed) {
